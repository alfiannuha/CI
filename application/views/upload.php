...
<head>
	<meta charset="utf-8">
	<title>Aplikasi Upload dan Download File</title>
...
<body>
<div id="container">
	<h1>Upload dan Download File Tanpa Database</h1>
	...
	<p class="footer">Akses halaman <strong>{elapsed_time}</strong> detik. <?php echo  (ENVIRONMENT === 'development') ?  'JTTC <strong>Yogyakarta</strong>' : '' ?></p>
</div>
